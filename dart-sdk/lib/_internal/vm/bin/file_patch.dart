...
abstract class _FileSystemWatcher {
  ...
  external static void _unwatchPath(int id, int pathId);
  @pragma("vm:external-name", "FileSystemWatcher_ReadEvents")
  external static List _readEvents(int id, int pathId);
  @pragma("vm:external-name", "FileSystemWatcher_GetSocketId")
  external static int _getSocketId(int id, int pathId);
}
