...
class Primitives {
  ...
  static int? valueFromDecomposedDate(
    ...
    if (value.isNaN ||
        ...
        value > maxMillisecondsSinceEpoch ||
        value == maxMillisecondsSinceEpoch && microseconds != 0) {
      return null;
    }
    return JS('int', '#', value);
  }
...
Future<void> loadDeferredLibrary(String loadId, String priority) {
...
Future _loadAllHunks(
  ...
  for (var hunkName in hunksToLoad) {
    _loadingLibraries[hunkName] = completer;
  }
