...
abstract final class ZoneDelegate {
  ...
  R runBinary<R, T1, T2>(Zone zone, R Function(T1 arg1, T2 arg2) f, T1 arg1, T2 arg2);

  // Invokes the [RegisterCallbackHandler] of the zone with a current zone.
  ZoneCallback<R> registerCallback<R>(Zone zone, R Function() f);

  // Invokes the [RegisterUnaryHandler] of the zone with a current zone.
  ZoneUnaryCallback<R, T> registerUnaryCallback<R, T>(Zone zone, R Function(T arg) f);
  ...
  Timer createPeriodicTimer(Zone zone, Duration period, void Function(Timer timer) f);
...
abstract final class Zone {
  ...
  ///
  /// See [runGuarded].
  void runUnaryGuarded<T>(void Function(T argument) action, T argument);
  ...
  void runBinaryGuarded<T1, T2>(
    void Function(T1 argument1, T2 argument2) action,
    T1 argument1,
    T2 argument2,
  );
  ...
  ZoneUnaryCallback<R, T> registerUnaryCallback<R, T>(R Function(T arg) callback);
  ...
  /// ```
  ZoneUnaryCallback<R, T> bindUnaryCallback<R, T>(R Function(T argument) callback);
  ...
  ZoneBinaryCallback<R, T1, T2> bindBinaryCallback<R, T1, T2>(
    R Function(T1 argument1, T2 argument2) callback,
  );
  ...
  /// ```
  void Function(T) bindUnaryCallbackGuarded<T>(void Function(T argument) callback);
  ...
  void Function(T1, T2) bindBinaryCallbackGuarded<T1, T2>(
    void Function(T1 argument1, T2 argument2) callback,
  );
  ...
  Timer createPeriodicTimer(Duration period, void Function(Timer timer) callback);
...
base class _ZoneDelegate implements ZoneDelegate {
  ...
  @override
  void scheduleMicrotask(Zone zone, Function() f) {
...
base class _CustomZone extends _Zone {
  ...
  @override
  void runGuarded(void Function() f) {
    try {
      run(f);
    } catch (e, s) {
  ...
  @override
  void runUnaryGuarded<T>(void Function(T arg) f, T arg) {
    try {
      runUnary(f, arg);
    } catch (e, s) {
      handleUncaughtError(e, s);
  ...
  @override
  void runBinaryGuarded<T1, T2>(void Function(T1 arg1, T2 arg2) f, T1 arg1, T2 arg2) {
    try {
  ...
  @override
  ZoneCallback<R> bindCallback<R>(R Function() f) {
    var registered = registerCallback(f);
    return () => run(registered);
  }

  @override
  ZoneUnaryCallback<R, T> bindUnaryCallback<R, T>(R Function(T arg) f) {
  ...
  @override
  void Function() bindCallbackGuarded(void Function() f) {
    var registered = registerCallback(f);
    return () => runGuarded(registered);
  }

  @override
  void Function(T) bindUnaryCallbackGuarded<T>(void Function(T arg) f) {
    var registered = registerUnaryCallback(f);
  ...
  @override
  void Function(T1, T2) bindBinaryCallbackGuarded<T1, T2>(
    void Function(T1 arg1, T2 arg2) f,
  ) {
    var registered = registerBinaryCallback(f);
  ...
  @override
  R runUnary<R, T>(R Function(T arg) f, T arg) {
  ...
  @override
  R runBinary<R, T1, T2>(R Function(T1 arg1, T2 arg2) f, T1 arg1, T2 arg2) {
  ...
  @override
  void scheduleMicrotask(void Function() f) {
  ...
  @override
  Timer createTimer(Duration duration, void Function() f) {
  ...
  @override
  Timer createPeriodicTimer(Duration duration, void Function(Timer timer) f) {
...
R _rootRun<R>(Zone? self, ZoneDelegate? parent, Zone zone, R Function() f) {
...
Zone _rootFork(
  ...
  } // TODO(lrn): Remove when type promotion works.
...
base class _RootZone extends _Zone {
  ...
  ZoneBinaryCallback<R, T1, T2> bindBinaryCallback<R, T1, T2>(
    ...
    return (arg1, arg2) => runBinary<R, T1, T2>(f, arg1, arg2);
  }
  ...
  @override
  ZoneCallback<R> registerCallback<R>(R Function() f) => f;

  @override
  ZoneUnaryCallback<R, T> registerUnaryCallback<R, T>(R Function(T arg) f) => f;
