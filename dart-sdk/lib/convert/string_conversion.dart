...
abstract mixin class StringConversionSink
  ...
  factory StringConversionSink.withCallback(void Function(String accumulated) callback) =
      _StringCallbackSink;
...
abstract interface class ClosableStringSink implements StringSink {
  ...
  factory ClosableStringSink.fromStringSink(StringSink sink, void Function() onClose) =
      _ClosableStringSink;
